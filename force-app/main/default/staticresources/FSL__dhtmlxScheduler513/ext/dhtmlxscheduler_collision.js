...
e._check_sections_collision=function(t,a){var i=e._get_section_property();return t[i]==a[i]&&t.id!=a.id},e.checkCollision=function(t){var i=[],n=e.config.collision_limit;if(t.rec_type)for(var r=e.getRecDates(t),s=0;s<r.length;s++)for(var o=e.getEvents(r[s].start_date,r[s].end_date),d=0;d<o.length;d++)(o[d].event_pid||o[d].id)!=t.id&&i.push(o[d]);else{i=e.getEvents(t.start_date,t.end_date);for(var _=0;_<i.length;_++){var l=i[_]
;if(l.id==t.id||l.event_length&&[l.event_pid,l.event_length].join("#")==t.id){i.splice(_,1);break}}}var h=e._get_section_view(),c=e._get_section_property(),u=!0;if(h){for(var v=0,_=0;_<i.length;_++)i[_].id!=t.id&&this._check_sections_collision(i[_],t)&&v++;v>=n&&(u=!1)}else i.length>=n&&(u=!1);if(!u){var g=!e.callEvent("onEventCollision",[t,i]);return g||(t[c]=a||t[c]),g}return u}}()});

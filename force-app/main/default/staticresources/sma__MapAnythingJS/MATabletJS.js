...
$(function () {
    ...
    *****************************************/
    ...
    var plottingOverwriteInt = setInterval(function () {
        if(typeof MAPlotting === 'object') {

            clearInterval(plottingOverwriteInt);
            MAPlotting.marker_Click = function(options) {
                options = $.extend({
                    markerType: 'marker'
                }, options || {});
                var marker = this;
...
var MALayers = {
    ...
    hideModal : function (modalSelector,hideMask) {
        ...
        if(modalSelector != undefined) {
            ...
            if(modalSelector === 'dynamicSearchModal') {
                ...
                .then(function(res) {
                    if (res.success) {
                        ...
                        MACustomShapes.drawV2({
                            ...
                            "description": data.sma__Description__c || '',
                            "baseObjectLabel": "N/A",
                            "modifiedInfo": "N/A",
    ...
    MAFolderSelector.launch()
        ...
        .fail(function(err) {
            ...
            if (err.cancel) {
                ...
                NotifyWarning('MapAnything Folder not selected successfully');
            }
        });
}

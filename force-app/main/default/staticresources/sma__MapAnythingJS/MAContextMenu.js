    ...
    $.contextMenu({
        ...
        build: function($trigger, e) {
            ...
            var menuItems = {
                ...
                massActions: { name: MASystem.Labels.MAContext_Mass_Actions, items: {} }
            };
            ...
            if(userSettings.ButtonSetSettings.massActionLayout && userSettings.ButtonSetSettings.massActionLayout.length > 0)
            {
                ...
                menuItems['massActions'].items['none'] = { name: MASystem.Labels.MAContext_No_Mass_Actions, disabled: true };
            }
            ...
            switch (ContextMenuClick.type)
            {
                case 'map':
                    ...
                    //header
                    menuItems.header.name = MASystem.Labels.MAContext_Map_Options;
                    ...
                    //center map here
                    menuItems.center = {
                        name: MASystem.Labels.MAContext_Center_Map_Here,
                        className: 'massbutton',
                        callback: function () {
                    ...
                    if ( $('#PlottedQueriesTable .FavoriteRowUnit').length !== 0 ) {
                        menuItems.removeFavorites= {
                            name: MASystem.Labels.MAContext_Remove_All_Favorites,
                            className: 'massbutton',
                    ...
                    if($('#search-wrapper').data('poiMarkers') && $('#search-wrapper').data('poiMarkers')._map !== null) {
                        menuItems.removePOI = { name: MASystem.Labels.MAContext_Remove_POI, className: 'massbutton', callback: removePOI };
                    }
                ...
                case 'marker':
                    ...
                    //header
                    menuItems.header.name = MASystem.Labels.MAContext_Marker_Options;
                    ...
                    if(ContextMenuClick.target.layerType == 'favorite-marker') {
                        menuItems.header.name = MASystem.Labels.MAContext_Favorite_Options;
                        menuItems.removeFavorite = {
                            name: MASystem.Labels.MAContext_Remove_Favorite,
                            className: 'massbutton',
                            callback: function () {
                    ...
                    if(ContextMenuClick.target.layerType == 'waypoint-marker') {
                        menuItems.header.name = MASystem.Labels.MAContext_Waypoint_Options;
                    }
                    ...
                    if(ContextMenuClick.target.layerType == 'whatsHere-marker')
                    {
                        ...
                        menuItems.removeMarker = {
                            name: MASystem.Labels.MAContext_Remove_Marker,
                    ...
                    {
                        menuItems.header.name = MASystem.Labels.MAContext_Search_Options;
                        menuItems.removeMarker = {
                            name: MASystem.Labels.MAContext_Remove_Marker,
                            callback: function(key, options) {
                                try {
                ...
                case 'cluster':
                    //header
                    menuItems.header.name = MASystem.Labels.MAContext_Cluster_Options;
                ...
                case 'scatter':
                    ...
                    //header
                    menuItems.header.name = MASystem.Labels.MAContext_Scatter_Options;
                ...
                case 'shape':
                    ...
                    if(isTravelGeom) {
                        ...
                        if(!isSavedTravel) {
                            menuItems.saveLayer = {
                                name: 'Save as shape layer',
                                callback : function (key, options) {
                                    //save the shape for later use
                                    var shape = ContextMenuClick.target;
    
                                    MACustomShapes.openPopupSidebar({shape:shape, shapeLayer: $layer});
                                }
                            }
                        }
                    }
                        ...
                        if ( shape.getEditable ) {
                            ...
                            var labelName = shape.getEditable() ? 'Stop Editing' : MASystem.Labels.MA_EDIT_SHAPE;
                    ...
                    menuItems.removeLayer = {
                        name: MASystem.Labels.MAContext_Remove_Layer,
                        callback: function(key, options) {
                            try
                            {

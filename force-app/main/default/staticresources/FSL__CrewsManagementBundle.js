...
function CrewManagementTerritory(ter, timezone) {
    ...
    this.label = '<div title="' + ter.Name.encodeHTML() + '" class="cm-territory-name truncate">' + ter.Name.encodeHTML() + '</div><div class="cm-timezone-gantt">' + timezone + ' (GMT' + gmtSign + window.Math.abs(timezoneDiffInHours) + ')</div>';

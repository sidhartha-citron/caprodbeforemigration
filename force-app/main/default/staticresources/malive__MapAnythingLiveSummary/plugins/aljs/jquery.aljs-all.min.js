/* ------------------------------------------------------------
This datepicker library was originally part of the ALJS
Lightning JS package written by Apiphony. It has since
been modified to fit the specific needs of MapAnything.
------------------------------------------------------------ */
if (typeof jQuery === "undefined") { throw new Error("Lightning JS requires jQuery") }
// Initializer
(function($) {
...
Datepicker
------------------------------------------------------------ */
if (typeof jQuery.aljs === "undefined") { throw new Error("Please include the initializer file") }
if (typeof moment === "undefined") { throw new Error("The datepicker plugin requires moment.js") }
    ...
    Datepicker.prototype = {
        ...
        initInteractivity: function() {
            ...
            var openDatepicker = function(e) {
                ...
                $([$el, $datepickerEl, $elEndDate]).each(function() { //, $el.prev('svg')
        ...
        fillMonth: function() {
            ...
            this.$datepickerEl.find('tbody').replaceWith($monthTableBody); // add month to datepicker element
        ...
        processBlur: function(e) {
            if (e) {
                ...
                if (self.$elEndDate && self.$elEndDate.length > 0 && self.$elEndDate[0] === self.$selectedInput[0]) { // Check if current input is for an end date; set end date
                    ...
                    if (momentSelectedFullDate.isValid()) {
                        ...
                        self.setSelectedFullDate('');
                        addMessage( self.$el, 'Incorrect date format entered\nPlease use a format like MM/DD/YYYY', 'error');
                    }
                }
            }  
        },

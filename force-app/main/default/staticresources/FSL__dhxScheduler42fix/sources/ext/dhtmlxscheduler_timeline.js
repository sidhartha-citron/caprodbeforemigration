...
scheduler._renderMatrix = function(mode, refresh) {
	...
	scheduler._max_date = scheduler.date["add_" + this.name + "_private"](scheduler._min_date, this.x_size*this.x_step);
	scheduler._table_view = true;
	if (this.second_scale) {

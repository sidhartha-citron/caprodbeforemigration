...
var defaults = {
	...
	monthNamesShort: [MonthJan,MonthFeb,MonthMar,MonthApr,MonthMay,MonthJun,MonthJul,MonthAug,MonthSep,MonthOct,MonthNov,MonthDec],
	dayNames: [WeekdaySunday,WeekdayMonday,WeekdayTuesday,WeekdayWednesday,WeekdayThursday,WeekdayFriday,WeekdaySaturday],
	dayNamesShort: [WeekdaySun,WeekdayMon,WeekdayTue,WeekdayWed,WeekdayThu,WeekdayFri,WeekdaySat],
	buttonText: {
		prev: '&nbsp;&#9668;&nbsp;',
		next: '&nbsp;&#9658;&nbsp;',
		prevYear: '&nbsp;&lt;&lt;&nbsp;',
...
var dateFormatters = {
	...
	T	: function(d)	{ return d.getHours() < 12 ? 'A' : 'P' },
	TT	: function(d)	{ return d.getHours() < 12 ? 'AM' : 'PM' },
	u	: function(d)	{ return formatDate(d, "yyyy-MM-dd'T00:00:00.000Z'") },
	S	: function(d)	{
		var date = d.getDate();

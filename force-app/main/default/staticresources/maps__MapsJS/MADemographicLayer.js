...
var MADemographicLayer = {
    ...
    plotMarkers: function (origOptions,dataLayerSFOptions) {
        ...
        markerQue.concurrency = 5;
        $plottedLayer.find('.status').text(MASystem.Labels.Layers_On_The_Map_Plotted_Data_Layer_Text_Data_Layer_Processing);
                ...
                if(event.status) {
                    if(res && res.success) {
                        ...
                        MADemographicLayer.createLegendInfo(legendOptions).then(function (normalizedLegend) {
                            ...
                            var customTileURL = MAIO_URL + '/tile/draw';
                    ...
                    setTimeout(function doBatch() {
                        if (i < len)
                        {
                            ...
                            while (recordsProcessed < markerProcessingBatchSize && i < len) {
                                ...
                                icon = {
                                    url : MAIO_URL + '/images/marker?color='+iconColor+'&forlegend=false&icon='+iconPart,

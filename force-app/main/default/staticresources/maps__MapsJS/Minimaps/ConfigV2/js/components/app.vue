    ...
    module.exports = {
        ...
        data: function() {
            return {
                ...
                defaultCardInfo: 'Default Nearby maps are standard in Maps. You cannot edit or delete these Nearby maps. They are the standard Nearby maps for your Maps users to view nearby records.'
            }
        },
        computed: {
        ...
        methods: {
            ...
            getCustomSettings: function(customOnly) {
                ...
                this.isLoading = true;
                var self = this;
                new RemoteAction('maps.RemoteActions', 'getMiniMapSettings')
                    ...
                    .invoke([ customOnly ], function(result) {
                        ...
                        for (var i = 0; i < result.length; i++) {
                            var setting = result[i];
                                isCustom = setting.record.maps__Is_Custom__c == true;

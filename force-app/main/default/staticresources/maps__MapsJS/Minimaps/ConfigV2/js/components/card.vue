...
<script>
    ...
    module.exports = {
        ...
        computed: {
            isCustom: function() {
                return this.setting.record.maps__Is_Custom__c;
            },
            recordName: function() {
                return this.setting.record.maps__Name__c;
            },
        ...
        methods: {
            ...
            getVFCode: function() {
                return '<apex:page standardController="' + this.setting.record.maps__Object__c + '" showHeader="false" sidebar="false"><style>html, body {height: 100%;width: 100%;}.ma-iframe-wrapper {width: 100%;height: 100%;}.ma-iframe-wrapper > iframe {width: 100%;height: 100%;}</style><div class="ma-iframe-wrapper"><iframe src="{!$Page.maps__Nearby}?rid={!$CurrentPage.parameters.id}&mmid=' + this.setting.record.Id + '"></iframe></div></apex:page>';
            },

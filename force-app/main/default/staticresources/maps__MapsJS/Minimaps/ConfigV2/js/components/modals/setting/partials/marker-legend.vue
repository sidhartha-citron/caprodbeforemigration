<template>
    <div class="slds-form-element slds-size--1-of-2">
        ...
        <div v-if="customMarkerSet || !standardMarkers" v-on-click-outside="doHide"> 
            ...
            <div style='font-size: 8px; margin-top: 6px;'>**{{ Labels.MA_Upload_Images }} <a href='https://help.salesforce.com/articleView?id=salesforce_maps_intro.htm&type=5' target='_blank'>here</a></div>
        </div>

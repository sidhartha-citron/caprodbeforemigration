        ...
        return items;
			...
			standardActions: {
				...
				'Remove C2C Marker': {
	           	...
	           	'Create Favorite': {
	           		Label: MASystem.Labels.ActionFramework_Create_Favorite, defaultIcon: 'ma-icon-favorite', Type: 'Standard Action', Modes: ['Mobile'], Layouts: ['Tooltip', 'MyPosition', 'POI'], Requirements: [], Action: 'Javascript', ActionValue: function (options) {
